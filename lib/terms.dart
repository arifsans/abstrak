    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
            'Other documents governing your use of our website In addition to these Terms of Use, your use of our website is also governed by the following documents:',
            style: Theme.of(context).textTheme.bodyLarge,
            textAlign: TextAlign.justify,
          ),
          SizedBox(height: 20),
          Text(
            'Our privacy policy, which is available at https://captive.my.id/pages/cookie-policy. Our privacy policy governs our use of your information. It sets out the types of information we collect, the reasons we collect it, how we use it, where we may pass it on to any third parties, in what circumstances and for what reasons, and any other relevant information relating to our use and/or processing of your information and your rights in relation to your information. Our cookies policy, which is available at https://captive.my.id/pages/cookie-policy. Our cookies policy governs our use of cookies [which are small files placed on the hard drive of a computer] and similar technologies on our website. It sets out the types of cookies we use, the purposes for which we use them, the circumstances in which we may place cookies on your computer, device or browser, and other relevant information relating to cookies, such as how to change your browser preferences and settings to accept or reject cookies',
            style: Theme.of(context).textTheme.bodyLarge,
            textAlign: TextAlign.justify,
          ),
          SizedBox(height: 20),
          ...
          SizedBox(height: 20),
          Text(
            'for any purpose that is unlawful or that in any way breaches any applicable laws or regulations, whether local, national or international; for any fraudulent purposes whatsoever; to conduct any unsolicited or unauthorised advertising or direct or indirect marketing to anyone by any means, or to otherwise spam, communicate with or market to anyone any goods, services or business not authorised by us; to upload, host or transmit any viruses, malware, adware, spyware, worms, Trojan horses, keystroke loggers, spyware, logic bombs, time bombs or any other harmful programs or code which could adversely affect the use or operation of the website, our hardware or systems, or the computers, tablets, phones or other devices of any users or other third parties, or to upload any content or materials containing any such content; to communicate with, harm or attempt to harm children in any way; or in any way or for any purpose that breaches these Terms of Use or the terms of any of the documents these Terms of Use refer to:',
            style: Theme.of(context).textTheme.bodyLarge,
            textAlign: TextAlign.justify,
          ),
          SizedBox(height: 20),
